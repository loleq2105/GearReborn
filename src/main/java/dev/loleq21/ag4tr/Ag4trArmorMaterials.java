...
public enum Ag4trArmorMaterials implements ArmorMaterial {
    ...
    COMPOSITE(64, new int[]{4, 8, 8, 4}, 8, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2.0F, 0.1F, () -> {
        return Ingredient.ofItems(TRContent.Plates.ADVANCED_ALLOY.asItem());
    }),
    ...
    DIVING(25, new int[]{2, 5, 6, 2}, 8, SoundEvents.ITEM_ARMOR_EQUIP_TURTLE, 0.0F, 0.0F, () -> {
        return Ingredient.ofItems(Items.SCUTE);
    }),
    MISCGEAR(15, new int[]{2, 5, 6, 2}, 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> {
