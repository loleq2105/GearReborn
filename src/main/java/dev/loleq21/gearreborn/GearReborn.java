...
public class GearReborn implements ModInitializer {
    ...
    public static final Identifier gogglesTogglePackedIdentifier = new Identifier(MOD_ID, "nvg_toggle");
    ...
    public void onInitialize() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(gogglesTogglePackedIdentifier, (client, handler, responseSender, buf, player) -> {
                handler.getEquippedStack(EquipmentSlot.HEAD).getOrCreateNbt().putBoolean("switchPressed", buf.readBoolean());
        });
    }
}
